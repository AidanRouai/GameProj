...
public class GameManager : MonoBehaviour
{
    ...
    float stopwatchTime; //Current time elapsed since the start of the game 
    public Text stopwatchDisplay;

    public bool isGameOver = false;
    public bool choosingUpgrade; //Check if the player is choosing upgrades
        ...
        switch (currentState)
        {
            ...
            case GameState.LevelUp:
                if (!choosingUpgrade)
                {
                    ...
                    Time.timeScale = 0f; //Pause the game while in the level up screen 
                    Debug.Log("Upgrade");
